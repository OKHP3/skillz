...
Agent Skills for building, presenting, and deploying projects on the Replit platform.
Covers the Replit workspace canvas, multi-artifact pnpm monorepo rules, the design
iteration pipeline, and building-in-public discipline for designathons and showcases.
These skills document the non-obvious rules and workflows that save multiple debugging
turns on any serious Replit project.
<!-- FAMILY_SUMMARY_END -->
