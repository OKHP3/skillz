...
Use YAML so a profile can be reviewed and edited without a runtime dependency. Fields marked required form the portable minimum. Additional project fields are welcome when they preserve the same provenance and role model.
