---
name: okhp3-repository-settings
description: >
...
with `okhp3-repository-creator`. The companion is optional, not a runtime dependency.
...
The package was renamed from okhp3-repo-settings on 2026-09-19. Earlier
review records retain their original package name, paths, and hashes. Those
records describe the frozen earlier artifact; a naming migration does not renew
its review approval or establish a current behavioral benchmark.
