# Composition with okhp3-repository-creator

The inspected companion is `universal/okhp3-repository-creator/SKILL.md`, version
...
3. Invoke `okhp3-repository-settings` with exact owner/repository, those decisions,
...
The earlier authored candidate used the originating project's
`.agents/skills/okhp3-repo-settings/` path. That historical source identifier does
not imply the originating copy was renamed. The current canonical distribution
path is `universal/okhp3-repository-settings/`, adjacent to the creator. Placement
does not establish publication or synchronization of other copies.
