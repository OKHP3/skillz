# Glee-fully GPT Builder Skill Manifest

## Package

- **Skill name:** `okhp3-glee-fully-gpt-builder`
- **Purpose:** Build, audit, improve, package, and govern Glee-fully Personalizable Tools and Tool-ettes as joyful, useful Custom GPT experiences.
- **Version:** `1.0.0`
...
4. Preserve the `name: okhp3-glee-fully-gpt-builder` metadata and folder-name match.
...
- Public positioning reference: https://glee-fully.tools
- Apply the Glee-fully identity contract in `SKILL.md` before the generic GPT lifecycle.
- Use `Tool` and `Tool-ette` deliberately, and record neighboring-tool handoffs.
- Choose Full, Standard, Lean, or None persona density based on user experience.
- Keep Glee-fully warmth, humor, and sparkle subordinate to clarity, evidence, safety, and user agency.
