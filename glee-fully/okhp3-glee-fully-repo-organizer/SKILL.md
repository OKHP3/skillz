---
name: okhp3-glee-fully-repo-organizer
description: >
...
Before profiling or reorganizing, read `references/brand-overlay.md`. It tunes repository language and decisions for the Glee-fully toolbox while preserving the generic evidence, safety, and approval rules.
