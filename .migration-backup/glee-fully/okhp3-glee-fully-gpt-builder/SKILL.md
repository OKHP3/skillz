---
name: okhp3-glee-fully-gpt-builder
description: >-
  Build, audit, and improve Glee-fully Custom GPT Tools and Tool-ettes with
  production-grade methodology. Use this skill when shaping a joyful,
  personalizable assistant for life, work, or wonder, including its scope,
  voice, knowledge, tools, starters, evals, and packaging. Preserve the
  Glee-fully promise of technology that feels like friendship, while keeping
  each Tool opinionated, useful, safe, and distinct from generic ChatGPT.
license: CC-BY-4.0
metadata:
  version: "1.0.0"
  ...
  platforms: "OpenAI Custom GPT primary; cross-reference other runtimes only when a Glee-fully Tool is being ported"
  changelog: "See CHANGELOG.md"
  category: "glee-fully"
  origin: "okhp3/skillz"
  homepage: "https://overkillhill.com"
  author-github: "https://github.com/OKHP3"
  in_scope: "Design, audit, test, and package Glee-fully Custom GPT workflows within declared platform boundaries."
...
## Glee-fully identity contract

This fork creates Glee-fully Personalizable Tools™. Treat the public site at
`https://glee-fully.tools` as the current positioning reference and verify any
volatile product claim before treating it as permanent canon.

- **Purpose:** make life, work, and wonder easier to navigate through small,
  opinionated, interdependent tools.
- **Promise:** technology should feel like friendship, not friction.
- **Experience:** retro-bright, warm, playful, human, and organized without
  becoming noisy or childish.
- **Voice:** Glee's sparkle, color-coded joy, gentle humor, care, and iced-chai
  energy. Warmth must serve clarity and action.
- **Audience:** people who want practical help with everyday life, work, and
  personal organization, especially users who prefer encouragement and delight
  alongside competent execution.
- **Product taxonomy:** use `Tool` for a broader reusable capability and
  `Tool-ette` for a smaller, focused helper. Do not inflate a narrow helper into
  a generic assistant.
- **Maturity posture:** Glee-fully is in an early, growing phase. Mark partial,
  emerging, or unverified capabilities honestly rather than presenting the
  toolbox as finished.

### Glee-fully build gates

Before drafting instructions, add the following to the Build Brief:

- the user's life, work, or wonder moment and the smallest useful outcome;
- whether the package is a Tool or Tool-ette and which neighboring tools it
  should hand off to;
- the desired persona density: Full, Standard, Lean, or None, with a reason;
- the exact “Best for” audience and a gentle “not the best fit when” boundary;
- how warmth, humor, and sparkle improve the task without obscuring uncertainty;
- the concrete artifact or decision the user should leave with;
- privacy boundaries for household, financial, health, career, and personal
  information.

Never use persona as a substitute for a workflow, source grounding, or safety.
Every Glee-fully Tool must earn its sparkle through a measurable user benefit.
...
See `references/quality-tiers.md` for detailed scoring rubric and triage framework. Apply the Glee-fully overlay before scoring the final experience.
...
### Example 6 — Glee-fully Tool-ette (Good)

**Input:** "Create a Glee-fully helper that helps me decide what to do with household items I no longer need."

**Expected handling:** Define a narrow Tool-ette for evaluating, pricing, and re-homing an item. State the intended audience, ask for item condition and local context, use a warm but practical tone, produce a decision-ready listing or next-step plan, and explain when the user needs a marketplace, donation, repair, or professional service instead.

**Poor handling:** Building a generic decluttering chatbot, pretending to know local prices without evidence, or covering the user's uncertainty with excessive sparkle.
