---
name: okhp3-glee-fully-extract-chatgpt
description: >
...
Before extracting ChatGPT material, read `references/brand-overlay.md`. It adds Glee-fully project routing, Tool/Tool-ette vocabulary, and voice-preservation rules without changing the adapter’s provenance or privacy contract.
