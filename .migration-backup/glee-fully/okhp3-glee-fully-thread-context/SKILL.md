---
name: okhp3-glee-fully-thread-context
description: >
...
metadata:
  ...
  in_scope: "Durable, provenance-aware extraction of supplied AI conversation context for Glee-fully workflows."
...
# okhp3-glee-fully-thread-context
...
Before extracting, read `references/brand-overlay.md`. It preserves Glee-fully voice, Tool taxonomy, and sibling relationships as labeled context while keeping assistant claims, private material, and inferred product canon distinct.
