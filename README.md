...
<!-- Generated: 2026-08-11 18:58 UTC | Families: 20 (16 active) -->

*20 families &nbsp;·&nbsp; 16 active &nbsp;·&nbsp; updated: **August 11, 2026 at 18:58 UTC***
...
| [`replit/`](replit/FAMILY.md) | 5 | Agent Skills for building, presenting, deploying, and maintaining projects on the Repli... |
| [`scripts/`](scripts/) | — placeholder | A family of 0 skills. No skills cataloged yet. |
| [`social-posting/`](social-posting/FAMILY.md) | 10 | Platform-specific drafts for LinkedIn, Facebook, X/Twitter, and Discord. |
| [`universal/`](universal/FAMILY.md) | 17 | A family of 11 skills. Create a Cloudflare Worker that proxies API calls from a static ... |
<!-- FAMILIES_TABLE_END -->
...
<!-- Generated: 2026-08-11 18:58 UTC | Skills: 125 | Categories: 16 | Mode: library | Surface: distribution -->

*Catalog last updated: **August 11, 2026 at 18:58 UTC** &nbsp;·&nbsp; **125** skills across **16** categories*
...
### social-posting (10 skills)

| Skill | Description | Version |
|---|---|---|
| [okhp3-discord-comment](social-posting/okhp3-discord-comment/SKILL.md) | Draft a Discord reply to a supplied message, thread, or forum conversation. Use when the user wan... | 1.0.0 |
| [okhp3-discord-post](social-posting/okhp3-discord-post/SKILL.md) | Draft a new Discord message, forum post, or thread opener for a named server destination. Use whe... | 1.0.0 |
| [okhp3-facebook-comment](social-posting/okhp3-facebook-comment/SKILL.md) | Draft a Facebook comment or reply to a supplied post and conversation. Use when the user wants to... | 1.0.0 |
| [okhp3-facebook-post](social-posting/okhp3-facebook-post/SKILL.md) | Draft a Facebook post for a named profile, Page, group, or event surface. Use when the user asks ... | 1.0.0 |
| [okhp3-linkedin-angles](social-posting/okhp3-linkedin-angles/SKILL.md) | Mine a finished artifact (PRD, SKILL.md, technical writeup, governance doc, Mermaid diagram, publ... | 2.0.0 |
| [okhp3-linkedin-comment](social-posting/okhp3-linkedin-comment/SKILL.md) | Draft a thoughtful LinkedIn comment or reply to an existing post. Use when the user wants to resp... | 1.0.0 |
| [okhp3-linkedin-post](social-posting/okhp3-linkedin-post/SKILL.md) | Draft a LinkedIn post from a chosen angle. Use when the user has picked a candidate from okhp3-li... | 2.0.0 |
| [okhp3-linkedin-voice](social-posting/okhp3-linkedin-voice/SKILL.md) | Apply the OKHP3 brand voice to any LinkedIn-bound text. Use as the FINAL pass on any LinkedIn pos... | 2.0.0 |
| [okhp3-twitter-comment](social-posting/okhp3-twitter-comment/SKILL.md) | Draft an X reply, called a Twitter comment in this family, to a supplied post and conversation. U... | 1.0.0 |
| [okhp3-twitter-post](social-posting/okhp3-twitter-post/SKILL.md) | Draft an X post using the portable name Twitter. Use when the user asks for a tweet, X post, conc... | 1.0.0 |
