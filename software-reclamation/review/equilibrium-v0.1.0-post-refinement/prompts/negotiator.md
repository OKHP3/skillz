# OKHP3 equilibrium review role: negotiator
...
Initial concordance classification: unknown
...
Role mandate:
Compare the initial review ledgers and any disruptor result. Choose a decisive test, adopt stronger evidence, narrow scope, add a guardrail, defer, or reject. Never average incompatible claims.

Other role outputs available as files:
- /Volumes/OKH-Local/04_GitHub_Mirrors/skillz/software-reclamation/review/equilibrium-v0.1.0-post-refinement/roles/evidence.stdout.txt
- /Volumes/OKH-Local/04_GitHub_Mirrors/skillz/software-reclamation/review/equilibrium-v0.1.0-post-refinement/roles/outcome.stdout.txt
- /Volumes/OKH-Local/04_GitHub_Mirrors/skillz/software-reclamation/review/equilibrium-v0.1.0-post-refinement/roles/safety_portability.stdout.txt
