...
metadata:
  ...
  in_scope: "Authoring a Process Narrative Specification from a completed intake and stakeholder register."
  out_of_scope: "Authoring without the required source evidence, unrelated document production, certification claims, or autonomous publication."
