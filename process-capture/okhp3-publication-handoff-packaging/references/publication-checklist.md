...
|---|---|
| `pir.yaml` | okhp3-process-intake-and-scope |
| `pns.yaml` | okhp3-process-narrative-authoring |
| `bpmn-beta.mmd` | okhp3-visual-process-modeling |
| `sop.md` | okhp3-sop-work-instructions |
| `validation-report.yaml` | okhp3-process-validation-scoring |

## Recommended Artifacts

| Artifact | Source skill |
|---|---|
| `stakeholder-register.yaml` | okhp3-stakeholder-and-role-mapping |
| `raci.md` | okhp3-raci-governance-matrix |
| `sipoc.md` | okhp3-sipoc-generation |
| `work-instructions.md` | okhp3-sop-work-instructions |
| `pns.md` | okhp3-process-narrative-authoring |
