...
metadata:
  ...
  in_scope: "First-pass process intake, boundary definition, business-rule capture, and Process Intake Record creation."
  out_of_scope: "Detailed current-state validation, future-state redesign, implementation, or invented process facts."
