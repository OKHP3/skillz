...
metadata:
  ...
  in_scope: "Current-state process capture and normalization into the documented as-is process artifact."
  out_of_scope: "Future-state redesign, solution selection, unauthorized publication, or claims beyond supplied process evidence."
