...
metadata:
  ...
  in_scope: "Process performance measures, KPIs, targets, and compliance controls derived from a validated process narrative."
  out_of_scope: "Unvalidated process redesign, operational control execution, legal certification, or unsupported target claims."
