...
metadata:
  ...
  in_scope: "DMN-aligned decision tables and explicit business rules for process decision points."
  out_of_scope: "Decision modeling below the stated gateway threshold, unrelated process redesign, unauthorized publication, or unsupported business claims."
