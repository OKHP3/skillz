...
1. All `critical` gaps before starting `okhp3-process-narrative-authoring`
2. All `major` Type 3 (exception) gaps before `okhp3-visual-process-modeling`
3. All `major` Type 4 (compliance) gaps before `okhp3-publication-handoff-packaging`
