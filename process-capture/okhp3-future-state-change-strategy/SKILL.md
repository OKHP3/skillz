...
metadata:
  ...
  in_scope: "Future-state process design and change strategy grounded in an as-is process and documented gap analysis."
  out_of_scope: "Current-state documentation only, unapproved implementation, unsupported organizational claims, or autonomous change execution."
