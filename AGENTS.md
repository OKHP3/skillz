...
- **Current inventory:** 76 distribution skills in 12 active families, 2 placeholder family directories, and 19 project-local support skills under `.agents/skills/`
...
- Generated catalogs reflect the current filesystem: `README.md` reports 75 distribution skills in 12 active families, `context-extraction/FAMILY.md` is active, and `.agents/skills/README.md` reports 18 project-local support skills.
