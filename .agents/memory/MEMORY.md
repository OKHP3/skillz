...
- [Catalog refresh drift](catalog-refresh-drift.md) — full catalog rebuilds can rewrite unrelated generated timestamps and surface pre-existing Forge payload drift; review and narrow the diff.
