...
node scripts/verify-archive-links.mjs
...
| `archive-link-validation` | After moving or editing preserved migration documents | Confirms the archived README notice and ledger scope remain present, archive-relative Markdown/image destinations resolve, and former-root targets remain available | Non-zero exit for missing targets, root-escaping paths, or missing archive-scope documentation |
