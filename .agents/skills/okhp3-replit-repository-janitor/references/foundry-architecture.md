...
garden.
## Current identity (2026-09-19)

The canonical name is now `okhp3-replit-repository-janitor`. The decision
above records the earlier replacement and is retained for provenance. Both
predecessors are preserved in the repository migration archive; neither is
an additional current distribution package.
