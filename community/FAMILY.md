...
generated_at: 2026-09-12T23:50:14Z
---
...
*107 skills &nbsp;·&nbsp; inventory last updated: **September 12, 2026 at 23:50 UTC***

| Skill | Description | Version |
|---|---|---|
| [acquire-codebase-knowledge](acquire-codebase-knowledge/SKILL.md) | Use this skill when the user explicitly asks to map, document, or onboard into an existing codeba... | 1.3 |
| [agent-governance](agent-governance/SKILL.md) | Patterns and techniques for adding governance, safety, and trust controls to AI agent systems. Us... | — |
| [agent-owasp-compliance](agent-owasp-compliance/SKILL.md) | Check any AI agent codebase against the OWASP Agentic Security Initiative (ASI) Top 10 risks. Use... | — |
| [agent-supply-chain](agent-supply-chain/SKILL.md) | Verify supply chain integrity for AI agent plugins, tools, and dependencies. Use this skill when:... | — |
...
| [api-design](api-design/SKILL.md) | Designs an interface other people will depend on — REST endpoints, RPC methods, library functions... | — |
| [api-documentation](api-documentation/SKILL.md) | Documents an interface others will call — endpoints, SDK methods, CLI commands, and their paramet... | — |
...
| [architecture-blueprint-generator](architecture-blueprint-generator/SKILL.md) | Comprehensive project architecture blueprint generator that analyzes codebases to create detailed... | — |
...
| [audit-integrity](audit-integrity/SKILL.md) | Shared audit integrity framework for all AppSec agents — enforces output quality, intellectual ho... | 1.0 |
...
| [code-exemplars-blueprint-generator](code-exemplars-blueprint-generator/SKILL.md) | Technology-agnostic prompt generator that creates customizable AI prompts for scanning codebases ... | — |
| [code-linting](code-linting/SKILL.md) | Sets up, fixes, or tunes linting and formatting for a project in any language — Python, JavaScrip... | — |
| [code-review](code-review/SKILL.md) | Reviews a change — a diff, a PR, a branch, or uncommitted work — for correctness, risk, and maint... | — |
| [code-tour](code-tour/SKILL.md) | Use this skill to create CodeTour .tour files — persona-targeted, step-by-step walkthroughs that ... | — |
| [codebase-architecture](codebase-architecture/SKILL.md) | >- | — |
| [codebase-discovery](codebase-discovery/SKILL.md) | Extract domain, architecture, business rules, workflows and a business glossary from an existing ... | — |
| [codebase-memory-mcp](codebase-memory-mcp/SKILL.md) | Use when exploring unfamiliar code, mapping architecture, finding symbols or relationships, traci... | — |
| [containerize-aspnet-framework](containerize-aspnet-framework/SKILL.md) | Containerize an ASP.NET .NET Framework project by creating Dockerfile and .dockerfile files custo... | — |
...
| [deployment-strategies](deployment-strategies/SKILL.md) | Gets a change into production safely — blue-green, canary, rolling, feature flags, and the rollba... | — |
| [devops-rollout-plan](devops-rollout-plan/SKILL.md) | Generate comprehensive rollout plans with preflight checks, step-by-step deployment, verification... | — |
| [diagramming](diagramming/SKILL.md) | Draws architecture and flow diagrams as code — Mermaid, C4, sequence, ER, and state diagrams that... | — |
| [doc-and-modernize](doc-and-modernize/SKILL.md) | >- | — |
| [documentation-writer](documentation-writer/SKILL.md) | Diátaxis Documentation Expert. An expert technical writer specializing in creating high-quality s... | — |
...
| [efcore-d2-db-diagram](efcore-d2-db-diagram/SKILL.md) | Generate D2 database diagrams from Entity Framework Core models. USE FOR: EF Core database diagra... | — |
...
| [folder-structure-blueprint-generator](folder-structure-blueprint-generator/SKILL.md) | Comprehensive technology-agnostic prompt for analyzing and documenting project folder structures.... | — |
...
| [incident-postmortem](incident-postmortem/SKILL.md) | Use when an outage, production incident, or significant service degradation has occurred and the ... | — |
| [integration-testing](integration-testing/SKILL.md) | Tests that components work together — service against real database, API against real dependencie... | — |
| [load-testing](load-testing/SKILL.md) | Measures how a system behaves under load and finds where it breaks — throughput ceilings, latency... | — |
| [log-analysis](log-analysis/SKILL.md) | Extracts an answer from logs, traces, or metrics — finding the relevant lines in volume, correlat... | — |
| [lsp-architecture](lsp-architecture/SKILL.md) | Generate a structural architecture overview of a codebase: languages, package map, entry points, ... | — |
| [lsp-dead-code](lsp-dead-code/SKILL.md) | Enumerate exported symbols in a file and surface those with zero references across the workspace.... | — |
| [lsp-docs](lsp-docs/SKILL.md) | Three-tier documentation lookup for any symbol — hover → offline toolchain doc → source definitio... | — |
| [lsp-refactor](lsp-refactor/SKILL.md) | End-to-end safe refactor workflow — blast-radius analysis, speculative preview, apply to disk, ve... | — |
| [lsp-test-correlation](lsp-test-correlation/SKILL.md) | Find and run the tests that cover a source file. Use after editing a file to discover exactly whi... | — |
| [markdown-docs](markdown-docs/SKILL.md) | Writes or restructures project documentation in Markdown — READMEs, guides, references, runbooks,... | — |
...
| [security-analysis](security-analysis/SKILL.md) | Reviews code or a change for exploitable vulnerabilities — injection, auth and access-control gap... | — |
...
| [tdd-best-practices](tdd-best-practices/SKILL.md) | Test-Driven Development guidance. Use when writing tests before implementation, applying Red-Gree... | 1.0.0 |
| [technology-stack-blueprint-generator](technology-stack-blueprint-generator/SKILL.md) | Comprehensive technology stack blueprint generator that analyzes codebases to create detailed arc... | — |
| [theme-factory](theme-factory/SKILL.md) | Toolkit for styling artifacts with a theme. These artifacts can be slides, docs, reportings, HTML... | — |
| [threat-model-analyst](threat-model-analyst/SKILL.md) | Full STRIDE-A threat model analysis and incremental update skill for repositories and systems. Su... | — |
