...
| --- | --- | --- |
| Node.js | 26.8.2 | latest stable Current release |
| Node.js LTS | 24.21.0 | recommended tracked runtime |
| Python | 3.14.7 | latest stable release |
| npm | 12.0.2 | npm registry latest tag |
| Anthropic Python SDK | 1.5.0 | PyPI latest release |
| MCP Python SDK | 2.2.0 | PyPI latest release |
| PyYAML | 6.0.3 | PyPI latest release |
| Mermaid CLI | 11.17.0 | npm latest tag |
| TypeScript | 7.0.2 | reference-only technology |
| Vite | 8.3.0 | reference-only technology |
| React | 19.3.0 | reference-only technology |
| Tailwind CSS | 4.3.3 | reference-only technology |
| pnpm | 12.4.1 | template bootstrap tool |
